...
- Ambient sound level: Avg (25 dB) and Max (28 dB)
- Ambient temperature: Avg (14 C) and Max (18 C)
- Delta sound level: -+ 1 dB
- Delta temperature level: -+ 1 C

| CPU Profile | RAM Profile | Method                 | App    | Duration | Avg dB | Max dB |
| ----------- | ----------- | ---------------------- | ------ | -------- | ------ | ------ |
| C-OC@1      | M-TI@1      | CPU+FPU+RAM Stress     | AIDA64 | 10 min   | ~44 dB | 50 dB  |
| C-OC@1      | M-TI@1      | CPU+FPU+RAM+GPU Stress | AIDA64 | 10 min   | ~50 dB | 55 dB  |
...
| CPU Profile | RAM Profile | Method                 | App    | Duration | CPU Temps     | System Temps  | VRM MOS       |
| ----------- | ----------- | ---------------------- | ------ | -------- | ------------- | ------------- | ------------- |
| C-OC@1      | M-TI@1      | CPU+FPU+RAM Stress     | AIDA64 | 10 min   | ~68C, 73C Max | ~34C, 36C Max | ~40C, 44C Max |
| C-OC@1      | M-TI@1      | CPU+FPU+RAM+GPU Stress | AIDA64 | 10 min   | ~80C, 87C Max | ~34C, 36C Max | ~44C, 48C Max |
...
| ----------- | --------------------- | -------- | --------------------- |
| CPU AIO     | -                     | CPU      | Normal                |
| CPU-OPT AIO | 50-60-70-75-80-85-90C | CPU      | 0-10-30-50-70-90-100% |
| Rear Case   | -                     | System 2 | Silent                |
| Front Case  | -                     | System 1 | Silent                |
| GPU FAN     | -                     | GPU      | Auto                  |
...
> This profiles only for 2 DIMM slots (32GB \* 2). 4 DIMM slots not yet configured nor tested.

- RWCL - Performance of Read, Write, Copy and Latency

| Details           | JEDEC-DDR-4800      | XMP-1                | M-TI@1              |
| ----------------- | ------------------- | -------------------- | ------------------- |
| **Status**        | -                   | -                    | **Active**          |
| Stability         | -                   | -                    | Verified            |
| &nbsp;            |                     |                      |                     |
| Clock / Frequency | 4800                | 6000 (**6400 fail**) | 6000                |
| MCLK              | 3000                | 3000                 | 3000                |
| FCLK              | 2000                | 2000                 | 2000                |
| UCLK              | 3000                | 3000                 | 3000                |
...
1. Open [Ethernet adapter settings](https://help.vicon.com/space/Connect/1607823/Configuring+network+card+settings+in+Windows+11) by following guide
2. Follow below settings table

| Name                                                                        | State    |
| --------------------------------------------------------------------------- | -------- |
| Power Management » Allow the computer to turn off this device to save power | Enabled  |
| Power Management » Allow this device to wake the computer                   | Enabled  |
| Power Management » Only allow a magic packet to wake the computer           | Enabled  |
| Advanced » Advanced EEE                                                     | Enabled  |
| Advanced » Energy-Efficient Ethernet                                        | Enabled  |
| Advanced » Green Ethernet                                                   | Enabled  |
| Advanced » Power Saving Mode                                                | Enabled  |
| Advanced » Shutdown Wake-on-Lan                                             | Disabled |
