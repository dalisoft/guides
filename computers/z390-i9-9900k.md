...
| Monitor     | Xiaomi     | [Mi 34" Curved](../tv/xiaomi-mi-curved-34.md) | -        |
...
| ----------- | ----------- | ---------------------- | ------ | -------- | ------ | ------ |
| C-OC@1      | M-OC@1      | CPU+FPU+RAM Stress     | AIDA64 | 10 min   | ~33 dB | 35 dB  |
| C-OC@1      | M-OC@1      | CPU+FPU+RAM+GPU Stress | AIDA64 | 10 min   | ~39 dB | 43 dB  |
...
| ----------- | ----------- | ---------------------- | ------ | -------- | ------------- | ------------- | ------------- |
| C-OC@1      | M-OC@1      | CPU+FPU+RAM Stress     | AIDA64 | 10 min   | ~65C, 72C Max | ~27C, 31C Max | ~44C, 54C Max |
| C-OC@1      | M-OC@1      | CPU+FPU+RAM+GPU Stress | AIDA64 | 10 min   | ~70C, 75C Max | ~35C, 39C Max | ~46C, 57C Max |
...
| Top         | 20-30-40-50     | System  | 0-30-60-90%      |
| GPU FAN     | -               | GPU     | Auto             |
...
1. From BIOS » [Settings » Platform Power](#settings--platform-power) disable **ErP**
2. From BIOS » [Settings » IO Ports](#settings--io-ports) enable **Wake on LAN Enable**
3. From BIOS » [Settings » IO Ports » Intel(R) Ethernet Connection](#settings--io-ports--intelr-ethernet-connection) enable **Wake On LAN**
4. Open [Ethernet adapter settings](https://help.vicon.com/space/Connect/1607823/Configuring+network+card+settings+in+Windows+11) by following guide
5. Follow below settings table
...
| Advanced » Enable PME                                                       | Enabled     |
| Advanced » Energy Efficient Ethernet                                        | Off         |
| Advanced » Reduce Speed on Power Down                                       | Enabled     |
| Advanced » System Idle Power Saver                                          | Disabled    |
| Advanced » Ultra Low Power Mode                                             | Enabled     |
| Advanced » Wait for Link                                                    | Auto Detect |
| Advanced » Wake on Link Settings                                            | Disabled    |
| Advanced » Wake on Magic Packet                                             | Enabled     |
| Advanced » Wake on Pattern Match                                            | Disabled    |

On some 10GbE Adapter may exist additional options

| Name                                 | State    |
| ------------------------------------ | -------- |
| Advanced » Wake from power off state | Disabled |
| Advanced » Wake on Ping              | Disabled |
